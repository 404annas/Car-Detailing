...
const Hero = () => {
    return (
        <section className="relative h-screen w-full">
            ...
            <div className="relative z-10 h-full flex items-center px-10 pt-10">
                <div className="max-w-2xl text-white space-y-6">
                    ...
                    <button className="relative overflow-hidden rounded-lg border border-orange-500 px-6 py-3 group cursor-pointer orb">
