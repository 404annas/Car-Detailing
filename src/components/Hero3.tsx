    ...
    return (
        <section className="bg-[#F7F8FA] pt-10 pb-10 overflow-hidden w-full">
            <div className="w-full flex flex-col items-center">
                ...
                {/* --- Heading --- */}
                <div className="container px-4 text-center mb-12 md:mb-14 z-20 relative">
                    <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#001B36] tracking-tight leading-[1.1]">
                        End-to-End <span className="text-[#007BFF]">Imports.</span> Zero Stress. Absolute Confidence. 
                    </h1>
                ...
                <div className="flex items-end justify-center w-[120%] md:w-full max-w-[1600px] relative -mb-4">
                    ...
                    <div className="flex-1 flex justify-end relative z-0 translate-x-8 md:-translate-x-10">
                        <Image
                            src={heroImg2}
                            alt="Red Truck"
                    ...
                    <div className="flex-1 flex justify-start relative z-0 -translate-x-8 md:translate-x-0">
                        <Image
                            src={heroImg3}
                            alt="Blue SUV"
