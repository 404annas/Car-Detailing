                ...
                <div className="w-full md:w-1/2 px-2 md:px-10 z-10">
                    ...
                    <form className="space-y-4">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 border border-gray-200 rounded-lg outline-none focus:border-[#050c4e] transition-colors placeholder:text-gray-400"
                        />
                        ...
                        <button
                            type="submit"
                            className="w-full bg-[#050c4e] hover:bg-[#040935] text-white font-bold py-4 rounded-lg transition-all duration-300 cursor-pointer uppercase tracking-wider text-sm"
                        >
                            Submit
                        </button>
                    </form>
