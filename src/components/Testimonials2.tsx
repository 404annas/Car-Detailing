                  ...
                  <div className="border border-gray-200 rounded-xl p-6 h-[250px] flex flex-col justify-between bg-white">
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        <h3 className="text-[#050c4e] font-medium text-lg truncate pr-2">
                          {review.name}
                        </h3>
                    ...
                    <button className="text-gray-400 text-sm underline self-start hover:text-[#050c4e] cursor-pointer transition-all duration-300 mt-2">
                      Read more
                    </button>
                  </div>
                </div>
